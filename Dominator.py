...
async def _(e):
    usage = "〄 ╔»⟦★ 𝐓𝐄𝐀𝐌 𝐃𝐎𝐌𝐈𝐍𝐀𝐓𝐎𝐑★⟧«╗ SᑭᗩᗰᗰEᖇ ᗷOT 〄\n\n【﻿×××𝗝𝗼𝗶𝗻×××】\n【﻿𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :】\n\n.join <Public Channel or Group Link/Username>"
...
text = """ FASTEST, SMOOTHEST AND POWERFUL  𝐓𝐄𝐀𝐌 𝐃𝐎𝐌𝐈𝐍𝐀𝐓𝐎𝐑 𝗦𝗣𝗔𝗠𝗕𝗢𝗧 DEPLOYED SUCCESSFULLY """

print(text)
print("")
print("SMEX!  𝐓𝐄𝐀𝐌 𝐃𝐎𝐌𝐈𝐍𝐀𝐓𝐎𝐑 𝗦𝗣𝗔𝗠𝗕𝗢𝗧 STARTED.")
